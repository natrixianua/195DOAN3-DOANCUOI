...
class CheckoutController extends Controller
{
 ...
 public function confirm_order(Request $request){
  ...
  Mail::send('pages.email.email',  ['cart_array'=>$cart_array, 'shipping_array'=>$shipping_array ,'code'=>$ordercode_mail] , function($message) use ($title_mail,$data){
...
public function lien_lac(Request $request){
 $slider = Slider::orderBy('slider_id','DESC')->where('slider_status','1')->take(4)->get();

  $meta_desc = "lienlac"; 
  $meta_keywords = "lienlac";
  $meta_title = "lienlac";
  $url_canonical = $request->url();
        //--seo 
  ...
  return view('pages.lienlac.lien_lac')->with('category',$cate_product)->with('brand',$brand_product)->with('meta_desc',$meta_desc)->with('meta_keywords',$meta_keywords)->with('meta_title',$meta_title)->with('url_canonical',$url_canonical)->with('city',$city)->with('slider',$slider);
}
}
