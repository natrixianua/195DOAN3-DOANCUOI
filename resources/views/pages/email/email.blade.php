		...
		<div class="col-md-12" >
			...
			<div class="row" style="background: cadetblue;padding: 15px">
				...
				<div class="col-md-6" style="text-align: center;color: #fff;font-weight: bold;font-size: 30px">
					<h4 style="margin:0">SHOP HOÀNG PHÚC</h4>
				...
				<div class="col-md-12">
					...
					<p>Mã coupon : <strong style="text-transform: uppercase;color:#fff">{{$code['coupon_code']}}</strong></p>
				...
				<p style="color:#fff">Xem lịch sử đơn hàng tại đây <a target="_blank" href="http://hoangphuc.com/">Shop</a>, </p>


				<p style="color:#fff">Mọi chi tiết xin liên hệ website tại : <a target="_blank" href="http://hoangphuc.com/">Shop</a>, hoặc liên hệ qua số hotline : 0774525140.Xin cảm ơn .</p>
